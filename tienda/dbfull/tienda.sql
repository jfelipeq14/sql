...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2023 a las 22:46:10
...
INSERT INTO `cajero` (`id`, `nombre`, `celular`, `email`, `idCiudad`) VALUES
('1001011144', 'felipe', '3128283881', 'jfelipeq14@gmail.com', '05001'),
('1025256555', 'Isabella', '3054685217', 'isabella@gmaol.com', '05001'),
('1037525333', 'angela', '3105981162', 'anglamarcet@gmail.com', '05212');
...
('3', 'Proteínas'),
('4', 'Productos lácteos'),
('5', 'Cereales, Granos y Pan'),
('6', 'Legumbres'),
('7', 'Frutos Secos y Semillas'),
('8', 'Productos de Panadería y Snacks'),
('9', 'Bebidas');
...
INSERT INTO `cliente` (`id`, `nombre`, `celular`, `email`, `idCiudad`) VALUES
('1', 'JULIO STEVEN ROJAS SIERRA', '3195543799', 'steven.rojas.sierra@gmail.com', '05001'),
('10', 'DISLEY CAROLINA TORRES MIRANDA', '3007274132', 'caritomiranda13@gmail.com', '05001'),
('11', 'ANGELA SARAI MARTINEZ CETINA', '3105981162', 'anglamarcet@gmail.com', '05212'),
('12', 'MARIA CAMILA RODRIGUEZ GOEZ', '3003426759', 'mariac.09rodriguez@gmail.com', '05001'),
('13', 'JUAN FELIPE QUINTERO GUTIERREZ', '3128283889', 'juan_fquintero@soy.sena.edu.co', '05001'),
('14', 'JUAN PABLO PALOMINO GUARIN', '3016042621', 'jppalomino6@soy.sena.edu.co', '05001'),
('15', 'KEIMER ANDRES LEZCANO CARVAJAL', '3005242585', 'keimerlezcano524@gmail.com', '05001'),
('16', 'MIGUEL ANGEL ESCOBAR OSORNO', '3177031376', 'miguelangelescobarosorno@gmail.com', '05001'),
('17', 'CARLOS ANDRES ALZATE CORREA', '3023777207', 'carlos_aalzate@soy.sena.edu.co', '05001'),
('18', 'DANIEL REALPE ECHEVERRI', '3004051439', 'daniel_realpee@soy.sena.edu.co', '05001'),
('19', 'ESTEBAN HERNANDEZ FLOREZ', '3008368588', 'esteban_hernandez2@soy.sena.edu.co', '05001'),
('2', 'ISABELLA RAMOS AMPUDIA', '3235790066', 'isabellaramosampudia@gmail.com', '05001'),
('20', 'EVELIN DANIELA CIFUENTES SUAREZ', '3106712670', 'cifuentesevelin147@gmail.com', '05001'),
('21', 'JOSE MANUEL RIVERA BEDOYA', '3046834707', 'jriverab52@hotmail.com', '05001'),
('22', 'JUAN SEBASTIAN BUSTAMANTE DUARTE', '3242978609', 'juan_sbustamante@soy.sena.edu.co', '05001'),
('23', 'SANDRA LILIANA ZAPATA GALLON', '3013880161', 'slzapata94@soy.sena.edu.co', '05001'),
('24', 'ALAN ANDREY SANCHEZ CARO', '3011111101', 'alaasanchez@soy.sena.edu.co', '05001'),
('25', 'ALEX DAVID ZULUAGA CARDONA', '3116841831', 'alexzulu012@gmail.com', '05001'),
('3', 'JUAN PABLO TORO LOPEZ', '3243073486', 'juanpa8954@gmail.com', '05001'),
('4', 'BRAYAN LEANDRO SANCHEZ PEÑA', '3052863004', 'brayan_lsanchez@soy.sena.edu.co', '05360'),
('5', 'JESUS EMILIO SERNA PEREA', '5555555555', 'jesus@gmail.com', '05001'),
('6', 'JUAN MANUEL VANEGAS BEDOYA', '3205982315', 'juan_mvanegas@soy.sena.edu.co', '05001'),
('7', 'SEBASTIAN MUÑOZ ACEVEDO', '3215699642', 'sebasmacevedo@gmail.com', '05001'),
('8', 'JUAN CARLOS MARTINEZ ORTEGA', '3154337519', 'juan_cmartinez2@soy.sena.edu.co', '05001'),
('9', 'MATEO GUTIERREZ MEZA', '3013887303', 'mateogutierrez0103@gmail.com', '05001');
...
('85', 'Casanare', '57'),
('86', 'Putumayo', '57'),
('88', 'Archipiélago de San Andrés, Providencia ', '57'),
('91', 'Amazonas', '57'),
('94', 'Guainía', '57'),
('95', 'Guaviare', '57'),
('97', 'Vaupés', '57'),
...
--
-- Estructura de tabla para la tabla `detallefacturaproducto`
--

CREATE TABLE `detallefacturaproducto` (
  `id` int(11) NOT NULL,
  `idFactura` int(11) DEFAULT NULL,
  `idProducto` char(5) DEFAULT NULL,
  `precio` int(11) DEFAULT NULL,
  `cantidad` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `detallefacturaproducto`
--

INSERT INTO `detallefacturaproducto` (`id`, `idFactura`, `idProducto`, `precio`, `cantidad`) VALUES
(1, 1, '12', 7000, 5),
(2, 11, '1', 6000, 7),
(3, 12, '2', 6750, 3),
(4, 13, '3', 8500, 6),
...
INSERT INTO `domiciliario` (`id`, `nombre`, `celular`) VALUES
('1007424566', 'Pablo', '3016042621'),
('1021804626', 'Alan', '3011111101'),
('1025045820', 'Toro', '3025485752');
...
CREATE TABLE `domicilio` (
  ...
  `idDomiciliario` varchar(10) NOT NULL,
...
INSERT INTO `domicilio` (`idFactura`, `idDomiciliario`, `valor`) VALUES
(1, '1021804626', 30000),
(2, '1021804626', 10000),
(3, '1007424566', 12000),
(11, '1007424566', 5000),
...
INSERT INTO `factura` (`id`, `fecha`, `idCliente`, `idCajero`) VALUES
(1, '2023-11-11', '20', '1001011144'),
(2, '2023-11-12', '7', '1001011144'),
(3, '2023-07-11', '8', '1001011144'),
(4, '2023-11-30', '16', '1025256555'),
(5, '2023-11-03', '13', '1025256555'),
(6, '2017-11-08', '17', '1001011144'),
(7, '2023-11-07', '9', '1025256555'),
(8, '2023-11-21', '14', '1037525333'),
(9, '2021-11-23', '14', '1025256555'),
(10, '2023-11-09', '16', '1025256555'),
(11, '2023-11-14', '1', '1001011144'),
(12, '2023-11-21', '2', '1025256555'),
(13, '2023-11-24', '3', '1037525333'),
(14, '2023-11-21', '4', '1001011144'),
(15, '2023-11-29', '5', '1025256555'),
(16, '2023-11-21', '6', '1001011144'),
(17, '2023-11-28', '7', '1025256555'),
(18, '2023-11-28', '8', '1037525333'),
(19, '2023-11-30', '11', '1037525333'),
(20, '2023-11-07', '14', '1037525333'),
(21, '2023-11-19', '15', '1001011144'),
(22, '2023-11-14', '16', '1025256555'),
(23, '2023-11-06', '18', '1025256555'),
(24, '2023-11-07', '19', '1037525333'),
(25, '2023-11-21', '21', '1037525333'),
(26, '2023-11-07', '25', '1025256555'),
(27, '2023-11-15', '15', '1025256555');
...
INSERT INTO `producto` (`id`, `nombre`, `idCategoria`, `precio`, `existencia`) VALUES
('1', 'Manzana', '1', 2500, 10),
('10', 'Gaseosa', '9', 2100, 14),
('11', 'Yogurt', '4', 1300, 10),
('12', 'Piña', '1', 4700, 9),
('13', 'tomate', '2', 3200, 8),
('14', 'Res', '3', 14000, 3),
('15', 'Pepinos', '2', 1700, 1),
('16', 'Pescado', '3', 7000, 4),
('17', 'Cordero', '3', 15000, 0),
('18', 'Fresas', '1', 2500, 25),
('19', 'Naranjas', '1', 3500, 12),
('2', 'Espinaca', '2', 3500, 15),
('20', 'Plátanos', '1', 2700, 32),
('21', 'Zanahorias', '2', 2100, 41),
('22', 'Brócoli', '2', 3400, 2),
('23', 'Lomito', '3', 9700, 3),
('24', 'Uvas', '2', 5500, 1),
('3', 'Pollo', '3', 12000, 25),
('4', 'Leche', '4', 3500, 31),
('5', 'Arroz', '5', 2500, 20),
('6', 'Lentejas', '6', 1500, 14),
('7', 'Almendras', '7', 3500, 0),
('8', 'Galletas', '8', 2500, 25),
('9', 'Agua', '9', 2000, 30);
...
--
-- Indices de la tabla `detallefacturaproducto`
--
...
ALTER TABLE `domicilio`
  ADD PRIMARY KEY (`idFactura`,`idDomiciliario`),
...
ALTER TABLE `factura`
  ...
  ADD KEY `factura_ibfk_2` (`idCajero`);
...
--
-- AUTO_INCREMENT de la tabla `detallefacturaproducto`
--
ALTER TABLE `detallefacturaproducto`
...
--
ALTER TABLE `cajero`
  ADD CONSTRAINT `cajero_ibfk_1` FOREIGN KEY (`idCiudad`) REFERENCES `ciudad` (`id`);

--
-- Filtros para la tabla `ciudad`
--
ALTER TABLE `ciudad`
  ADD CONSTRAINT `ciudad_ibfk_1` FOREIGN KEY (`idDepartamento`) REFERENCES `departamento` (`id`);

--
-- Filtros para la tabla `cliente`
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`idCiudad`) REFERENCES `ciudad` (`id`);
...
--
-- Filtros para la tabla `detallefacturaproducto`
--
ALTER TABLE `detallefacturaproducto`
  ADD CONSTRAINT `detallefacturaproducto_ibfk_1` FOREIGN KEY (`idFactura`) REFERENCES `factura` (`id`),
  ADD CONSTRAINT `detallefacturaproducto_ibfk_2` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`id`);

--
-- Filtros para la tabla `domicilio`
--
ALTER TABLE `domicilio`
  ADD CONSTRAINT `domicilio_ibfk_1` FOREIGN KEY (`idFactura`) REFERENCES `factura` (`id`),
  ADD CONSTRAINT `domicilio_ibfk_2` FOREIGN KEY (`idDomiciliario`) REFERENCES `domiciliario` (`id`);
...
ALTER TABLE `factura`
  ...
  ADD CONSTRAINT `factura_ibfk_2` FOREIGN KEY (`idCajero`) REFERENCES `cajero` (`id`);

...
--
INSERT INTO
  `cajero` (`id`, `nombre`, `celular`, `email`, `idCiudad`)
VALUES
  (
    '1001011144',
    'felipe',
    '3128283881',
    'jfelipeq14@gmail.com',
    '05001'
  ),
  (
    '1037525333',
...
--
INSERT INTO
  `ciudad` (`id`, `nombre`, `idDepartamento`)
VALUES
  ('05001', 'MEDELLÍN', '05'),
  ('05002', 'ABEJORRAL', '05'),
  ('05004', 'ABRIAQUÍ', '05'),
...
--
INSERT INTO
  `cliente` (`id`, `nombre`, `celular`, `email`, `idCiudad`)
VALUES
  (
    '1',
    'JULIO STEVEN ROJAS SIERRA',
    '3195543799',
    'steven.rojas.sierra@gmail.com',
    '05001'
  ),
  (
    '10',
    'DISLEY CAROLINA TORRES MIRANDA',
    '3007274132',
    'caritomiranda13@gmail.com',
    '05001'
  ),
  (
    '11',
  ...
  (
    '12',
    'MARIA CAMILA RODRIGUEZ GOEZ',
    '3003426759',
    'mariac.09rodriguez@gmail.com',
    '05001'
  ),
  (
    '13',
    ...
    '3128283889',
    'juan_fquintero@soy.sena.edu.co',
    '05001'
  ),
  (
    '14',
    ...
    '3016042621',
    'jppalomino6@soy.sena.edu.co',
    '05001'
  ),
  (
    '15',
    'KEIMER ANDRES LEZCANO CARVAJAL',
    '3005242585',
    'keimerlezcano524@gmail.com',
    '05001'
  ),
  (
    '16',
    'MIGUEL ANGEL ESCOBAR OSORNO',
    '3177031376',
    'miguelangelescobarosorno@gmail.com',
    '05001'
  ),
  (
    '17',
    'CARLOS ANDRES ALZATE CORREA',
    '3023777207',
    'carlos_aalzate@soy.sena.edu.co',
    '05001'
  ),
  (
    '18',
    ...
    '3004051439',
    'daniel_realpee@soy.sena.edu.co',
    '05001'
  ),
  (
    '19',
    'ESTEBAN HERNANDEZ FLOREZ',
    '3008368588',
    'esteban_hernandez2@soy.sena.edu.co',
    '05001'
  ),
  (
    '2',
    ...
    '3235790066',
    'isabellaramosampudia@gmail.com',
    '05001'
  ),
  (
    '20',
    'EVELIN DANIELA CIFUENTES SUAREZ',
    '3106712670',
    'cifuentesevelin147@gmail.com',
    '05001'
  ),
  (
    '21',
    ...
    '3046834707',
    'jriverab52@hotmail.com',
    '05001'
  ),
  (
    '22',
    'JUAN SEBASTIAN BUSTAMANTE DUARTE',
    '3242978609',
    'juan_sbustamante@soy.sena.edu.co',
    '05001'
  ),
  (
    '23',
    'SANDRA LILIANA ZAPATA GALLON',
    '3013880161',
    'slzapata94@soy.sena.edu.co',
    '05001'
  ),
  (
    '24',
    ...
    '3011111101',
    'alaasanchez@soy.sena.edu.co',
    '05001'
  ),
  (
    '25',
    'ALEX DAVID ZULUAGA CARDONA',
    '3116841831',
    'alexzulu012@gmail.com',
    '05001'
  ),
  (
    '3',
    ...
    '3243073486',
    'juanpa8954@gmail.com',
    '05001'
  ),
  (
    '4',
    'BRAYAN LEANDRO SANCHEZ PEÑA',
    '3052863004',
    'brayan_lsanchez@soy.sena.edu.co',
    '05360'
  ),
  (
    '5',
    'JESUS EMILIO SERNA PEREA',
    '5555555555',
    'jesus@gmail.com',
    '05001'
  ),
  ...
  (
    ...
    '3215699642',
    'sebasmacevedo@gmail.com',
    '05001'
  ),
  (
    '8',
    'JUAN CARLOS MARTINEZ ORTEGA',
    '3154337519',
    'juan_cmartinez2@soy.sena.edu.co',
    '05001'
  ),
  (
    '9',
    'MATEO GUTIERREZ MEZA',
    '3013887303',
    'mateogutierrez0103@gmail.com',
    '05001'
  );
...
--
INSERT INTO
  `domiciliario` (`id`, `nombre`, `celular`)
VALUES
...
--
INSERT INTO
  `domicilio` (`idFactura`, `idDomiciliario`, `valor`)
VALUES
  (1, '1021804626', 30000);
...
--
INSERT INTO
  `factura` (`id`, `fecha`, `idCliente`, `idCajero`)
VALUES
...
ALTER TABLE
  `domicilio`
ADD
  PRIMARY KEY (`idFactura`, `idDomiciliario`),
ADD
  KEY `idDomiciliario` (`idDomiciliario`);
...
ALTER TABLE
  `cajero`
ADD
  CONSTRAINT `cajero_ibfk_1` FOREIGN KEY (`idCiudad`) REFERENCES `ciudad` (`id`);
...
ALTER TABLE
  `ciudad`
ADD
  CONSTRAINT `ciudad_ibfk_1` FOREIGN KEY (`idDepartamento`) REFERENCES `departamento` (`id`);
...
ALTER TABLE
  `detallefacturaproducto`
ADD
  CONSTRAINT `detallefacturaproducto_ibfk_1` FOREIGN KEY (`idFactura`) REFERENCES `factura` (`id`),
ADD
  CONSTRAINT `detallefacturaproducto_ibfk_2` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`id`);
...
ALTER TABLE
  `domicilio`
ADD
  CONSTRAINT `domicilio_ibfk_1` FOREIGN KEY (`idFactura`) REFERENCES `factura` (`id`),
ADD
  CONSTRAINT `domicilio_ibfk_2` FOREIGN KEY (`idDomiciliario`) REFERENCES `domiciliario` (`id`);
...
ADD
  CONSTRAINT `factura_ibfk_2` FOREIGN KEY (`idCajero`) REFERENCES `cajero` (`id`);
